# nvim-treesitter-queries-gosum

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gosum/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gosum/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gosum**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gosum",
...
- [ ] Changes are scoped to `gosum` — do not include files for other languages
